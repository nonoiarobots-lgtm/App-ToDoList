...
|---|---|---|
| [cadrage-complet.md](docs/cadrage-complet.md) | v4 | **Référence fonctionnelle** — specs, cycle de vie, flux, décisions |
| [besoins-utilisateurs.md](docs/besoins-utilisateurs.md) | v2 | Besoins utilisateurs (BU-xx) et critères d'acceptation |
| [inventaire-ecrans.md](docs/inventaire-ecrans.md) | v1 | Liste des écrans et états |
| [audit-technique.md](docs/audit-technique.md) | v1 | Arbitrages techniques (PWA, Supabase, offline V2) et risques |
| [schema-base-donnees.md](docs/schema-base-donnees.md) | v1 | Schéma PostgreSQL/Supabase, RLS, index |
| [api-principales.md](docs/api-principales.md) | v1 | Endpoints Next.js Route Handlers |
| [prompt-engineering.md](docs/prompt-engineering.md) | v1 | Prompts Claude API (découpage + pré-caractérisation) |
| [tests-tdd.md](docs/tests-tdd.md) | v1 | Catalogue de 177 tests (unit / integration / e2e) |
| [plan-demarrage.md](docs/plan-demarrage.md) | v1 | Les 10 actions de setup avant la première feature |
